...
const Banner = () => {
  ...
  <div className="hero min-h-screen" style={{backgroundImage: 'url(https://i.ibb.co/6ZsngS9/baby-shower-4.jpg)'}}>
  ...
  <div className="hero min-h-screen" style={{backgroundImage: 'url(https://i.ibb.co/ydkB8Cr/wedding-5.jpg)'}}>
  <div className="hero-overlay bg-opacity-60"></div>
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
  ...
  <div className="hero min-h-screen" style={{backgroundImage: 'url(https://i.ibb.co/3dvCx0N/engagement-2.jpg)'}}>
  <div className="hero-overlay bg-opacity-60"></div>
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
  ...
  <div className="hero min-h-screen" style={{backgroundImage: 'url(https://i.ibb.co/72bJR0X/baby-shower-1.jpg)'}}>
  <div className="hero-overlay bg-opacity-60"></div>
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
